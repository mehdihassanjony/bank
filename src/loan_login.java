...
public class loan_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Loan's Login");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/047-512.png"))); // NOI18N
        ...
        customer_login.setText("Custom's Login");
    ...
    private void admin_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_admin_loginActionPerformed
        // TODO add your handling code here:
        String sql ="select * from loan_info where email=? and password =?";
        try{
            ...
            if(rs.next())
            {
                ...
                loan_home s = new loan_home();
                s.setVisible(true);
                this.dispose();
                s.loanID(email.getText());
            }
            else
            {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loan_login().setVisible(true);
            }
        });
    }
